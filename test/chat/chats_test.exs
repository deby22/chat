defmodule Chat.ChatsTest do
  ...
  describe "messages" do
    ...
    @valid_attrs %{body: "some body", g: "some g", name: "some name"}
    @update_attrs %{body: "some updated body", g: "some updated g", name: "some updated name"}
    @invalid_attrs %{body: nil, g: nil, name: nil}
    ...
    test "update_message/2 with valid data updates the message" do
      ...
      assert message.g == "some updated g"
